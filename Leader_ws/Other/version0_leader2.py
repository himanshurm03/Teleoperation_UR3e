...
############################################################################
#Maximum 3N of force is sent as force feedback to the haptic device.
...
#         # ADDED: Maximum force limit for haptic device (in Newtons)
#         self.MAX_FORCE = 3.0  # 3N maximum per axis
...
#         """
#         Limit force components to maximum allowed value per axis.
#         Each component is independently clamped to [-MAX_FORCE, +MAX_FORCE].
        
#         Args:
#             force_x, force_y, force_z: Input force components
            
#         Returns:
#             Tuple of (limited_x, limited_y, limited_z)
#         """
...
#         # 1. Extract and publish force to haptic device with limiting
#         receive_time = rospy.get_time()
        
#         # ADDED: Apply force limiting before sending to haptic device
#         limited_x, limited_y, limited_z = self.limit_force(msg.force.x, msg.force.y, msg.force.z)
...
class MasterController:
    ...
    def save_force_limiting_log_to_csv(self, filepath="/home/autonomous-lab/Desktop/delay/force_limiting.csv"):
        ...
        try:
            ...
            # Print statistics about force limiting
...
#         # Subscribers
#         rospy.Subscriber('slave_to_master_data', SlaveToMasterData, self.slave_to_master_callback) #TCP 
#         # rospy.Subscriber('slave_to_master_data', SlaveToMasterData, self.slave_to_master_callback,
...
#             bundled_msg.header.stamp = rospy.Time.now()  # Contains pose generation timestamp
