...
class HapticForceController:
    ...
    def __init__(self):
        ...
        self.file_path_recieve = '/home/user/experiment_data/standard/force_data_for_exp_interpolated.csv'
        self.file_path_store = '/home/user/experiment_data/15_april_2025/Library_Hotspot/force_data.csv'
