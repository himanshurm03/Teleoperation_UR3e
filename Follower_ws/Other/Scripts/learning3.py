...
class RobotEndEffectorController:
    ...
    def tf_callback(self, msg: TFMessage):
        ...
        try:
            ...
            current_ee_pose = np.array([
                [self.filtered_linear[0]], [self.filtered_linear[0]], [self.filtered_linear[0]],
    ...
    def plot_data(self):
        ...
        axs[1].plot(times[1000:], initial_ee_poses[1000:]-current_ee_poses[1000:])
        axs[1].set_title('Delta End Effector Pose')
