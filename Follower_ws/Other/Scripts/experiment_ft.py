...
class HapticForceController:
    ...
    def __init__(self):
        ...
        self.robot_force_exp = []
        self.time_stamps_exp = []

        # For csv
        self.base_dir = '/home/user/experiment_data/standard'
        self.exp_force_filename = 'force_data_for_exp.csv'
        self.exp_force_interpolated_filename = 'force_data_for_exp_interpolated.csv'
    ...
    def robot_force_callback(self, msg: WrenchStamped):
        ...
        current_time = current_time- self.start_time_exp

        frequency = 0.5  
        amplitude = 0.25

        # Generate sinusoidal forces
        robot_force = np.array([
            amplitude * np.sin(2 * np.pi * frequency * current_time),  # Force in x direction
            amplitude * np.sin(2 * np.pi * frequency * current_time + np.pi / 2),  # Force in y direction
            amplitude * np.sin(2 * np.pi * frequency * current_time + np.pi)  # Force in z direction
    ])
        
        self.robot_force = robot_force
        self.time_stamps_exp.append(current_time)
        self.robot_force_exp.append(robot_force.flatten())
    ...
    def make_csv(self):
        file_path = f'{self.base_dir}/{self.exp_force_filename}'
    ...
    def make_csv_exp_interpolated(self):
        ...
        stylus_pose_plot = np.array(self.robot_force_exp)
        ...
        file_path = f'{self.base_dir}/{self.exp_force_interpolated_filename}'
    ...
    def shutdown_hook(self):
        ...
        self.make_csv()
        self.make_csv_exp_interpolated()
        self.plot_data()
