...
class HapticForceController:
    ...
    def make_csv(self):
        with open('/home/user/Desktop/delay/wcamera/force.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
            writer.writerow([
    ...
    def make_csv_for_delay(self):
        with open('/home/user/Desktop/delay/wcamera/forced.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
    ...
    def make_csv_for_generation_and_send(self):
        with open('/home/user/Desktop/delay/wcamera/force_gen_send.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
