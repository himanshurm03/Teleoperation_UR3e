...
class HapticForceController:
    ...
    def haptic_force_callback(self, event):
        ...
        force_pub_msg.force.x, force_pub_msg.force.y, force_pub_msg.force.z = 0.25*robot_force
    ...
    def make_csv(self):
        with open('/home/user/experiment_data/harshit2/aditya/force_data5.csv', 'w', newline='') as csvfile:
